...
#
# ChatAnthropic wraps the Anthropic API. The model= parameter picks which
# Claude version to use. You could swap this for ChatOpenAI("gpt-4o") or
# ChatGoogleGenerativeAI("gemini-pro") and the rest of the code stays the same.
#
